(function () {
  ...
  var INDEX = [
    ...
    { url: 'conferencias-presenciales.html', title: 'Conferencias Presenciales', desc: 'Ponencias presenciales ante organismos empresariales y ecosistemas de emprendimiento.', keys: 'conferencias presenciales ponencia techstars coparmex jornada laboral ley silla igualdad sustantiva violencia bma barra mexicana abogados prevención' },
    ...
    { url: 'curso-derecho-trabajo-ss.html', title: 'Curso: Derecho del Trabajo y Seguridad Social', desc: 'Temario, ponentes y detalles del curso con enfoque empresarial. 7 sesiones, modalidad híbrida.', keys: 'curso derecho trabajo seguridad social empresarial repse riesgos colectivo salario mínimo icsoe sisub créditos fiscales imss jornada 40 horas temario ponentes ipd' },
    ...
    { url: 'diplomado-seguridad-social.html', title: 'Diplomado en Derecho de la Seguridad Social', desc: 'Temario completo, costos y detalles del diplomado. 10 módulos: IMSS, pensiones, AFORES, INFONAVIT, REPSE, fiscalización y litigio.', keys: 'diplomado seguridad social imss pensiones sar afores infonavit repse icsoe sisub fiscalización litigio temario costos módulos ipd dayana reyes' },
    { url: 'boletin-laboral.html', title: 'Boletín Laboral', desc: 'Actualizaciones periódicas sobre reformas legislativas, criterios judiciales y novedades en materia laboral y de seguridad social.', keys: 'boletín laboral reforma jornada teletrabajo salario mínimo nom criterios judiciales actualización' },
    { url: 'boletin-reforma-jornada-40-horas.html', title: 'Reforma Jornada 40 Horas', desc: 'Análisis de la reforma constitucional que reduce la jornada laboral a 40 horas semanales.', keys: 'reforma jornada 40 horas constitución empresas obligaciones patronales transición implementación' },
    { url: 'boletin-nom-037-teletrabajo.html', title: 'NOM-037 Teletrabajo', desc: 'Obligaciones patronales bajo la NOM-037-STPS-2023 en materia de teletrabajo.', keys: 'nom 037 teletrabajo stps seguridad salud ergonomía desconexión digital home office remoto' },
    { url: 'boletin-salario-minimo-2026.html', title: 'Salario Mínimo 2026', desc: 'Impacto del incremento al salario mínimo en cuotas obrero-patronales y prestaciones.', keys: 'salario mínimo 2026 cuotas imss infonavit prestaciones aguinaldo vacaciones indemnización uma conasami' },
