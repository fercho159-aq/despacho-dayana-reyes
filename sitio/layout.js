...
(function () {
  ...
  var header = ''
    ...
    + '      <span class="logo__mark" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v18M5 21h14M3 7h18M7 7l-3 7a3 3 0 0 0 6 0L7 7zM17 7l-3 7a3 3 0 0 0 6 0l-3-7z"/></svg></span>'
    + '      <span class="logo__text"><span class="logo__name">Dayana Reyes</span><span class="logo__tag">y Abogados</span></span>'
    + '    </a>'
    ...
    + '              <ul>'
    + '                <li><a href="practica-legal.html#lab-consultoria">Consultoría laboral individual y colectiva</a></li>'
    ...
    + '                <li><a href="actualidad-legal.html#publicaciones">Publicaciones</a></li>'
    + '                <li><a href="actualidad-legal.html#entrevistas">Entrevistas</a></li>'
    + '                <li><a href="actualidad-legal.html#conferencias-presenciales">Conferencias presenciales</a></li>'
    + '                <li><a href="actualidad-legal.html#conferencias-virtuales">Conferencias virtuales</a></li>'
    + '                <li><a href="actualidad-legal.html#mesas-debate">Mesas de discusión y debate</a></li>'
    + '              </ul>'
    + '            </div>'
    + '            <div class="mega-col">'
    + '              <span class="mega-col__title">Eventos y medios</span>'
    + '              <ul>'
    + '                <li><a href="actualidad-legal.html#mesas-redondas">Mesas redondas</a></li>'
  ...
  var footer = ''
    ...
    + '          <li><a href="practica-legal.html#area-administrativo">Constitucional y Administrativo</a></li>'
    + '          <li><a href="actualidad-legal.html">Actualidad Legal</a></li>'
    + '          <li><a href="contacto.html">Contacto</a></li>'
    + '        </ul>'
    + '      </nav>'
    + '      <div class="footer__col">'
    + '        <h4>Contacto en CDMX</h4>'
    ...
    + '        <p class="footer__contact-line"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-10 5L2 7"/></svg> <a href="mailto:dreyes@dayanareyesabogados.mx">dreyes@dayanareyesabogados.mx</a></p>'
    + '      </div>'
    + '    </div>'
